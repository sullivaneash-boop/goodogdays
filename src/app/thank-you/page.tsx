...
export default function ThankYouPage() {
  return (
    <main id="top" className="simple-page">
      ...
      <section className="simple-hero" id="main-content" aria-labelledby="thank-you-title">
        <div className="shell simple-hero-inner">
          ...
          <p>We’ll review your location, schedule and what your dog needs, then follow up about availability and arrange any introduction. Your care is not booked yet.</p>
